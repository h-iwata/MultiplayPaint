...
bool ListController::addItem(const char* name)
{
	CCLabelTTF* label = CCLabelTTF::create(name, FONT_NAME, LOG_FONT_SIZE);
...
bool ListController::removeItem(const char* name)
{
	unsigned int i = 0;
...
void ListController::scrollToBottom()
{
